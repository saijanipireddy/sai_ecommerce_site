        ...
        >
          ...
          <div className="w-[80%] h-[130px] flex items-start justify-center flex-col mt-[20px] gap-[10px]">
            ...
            <div className="w-[100%] h-[100%] flex items-center justify-start">
              <label
                htmlFor="image1"
                className="w-[65px] h-[65px] md:w-[100px] md:h-[100px] cursor-pointer hover:border-[#46d1f7] border-2 border-dashed rounded-lg flex items-center justify-center overflow-hidden m-4"
              >
                {image1 ? (
                  <img
          ...
          <div className='w-[80%] flex items-start justify-center flex-col gap-[10px]'>
               ...
               <textarea
                type="text"
                placeholder="Type here"
                className="w-[600px] max-w-[98%] h-[100px] rounded-lg
                          hover:border-[#46d1f7] border-[2px] cursor-pointer 
          ...
          <div className='w-80% flex items-center gap-[10px] flex-wrap' >
            <div className='md:w-[30%] w-[100%] flex items-start sm:justify-center flex-col gap-[10px]'>
              ...
              <select name="" id="" className='bg-slate-600 w-[60%] p-[10px] py-[7px] rounded-lg hover:border-[#46d1f7] border-[2px]'
          ...
          <div className='w-[80%] h-[100px] flex items-start justify-center flex-col gap-[10px]'>
               ...
               <input
                ...
                className="w-[600px] max-w-[98%] h-[40px] rounded-lg
                          hover:border-[#46d1f7] border-[2px] cursor-pointer 
                          bg-slate-600 px-[20px] text-[18px] placeholder:text-[#ffffffc2]" onChange={(e)=>setPrice(e.target.value)} value={price} required
                />
